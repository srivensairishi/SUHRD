...
function UserTicketForm(){
    return(
        ...
        <div className="w-full max-w-md mx-auto mt-6 md:mt-10 p-4 mb-16">
            ...
            <button className="w-full py-2 text-sm md:text-base rounded shadow-md text-white font-semibold bg-gradient-to-r from-fuchsia-500 to-purple-600 hover:opacity-90 transition"> SUBMIT</button>
        </div>
