                ...
                <div className='flex flex-col justify-between items-center'>
                    {news.map((news) => (
                        <div key={news.id} className='h-40 w-full rounded-lg flex jutify-center items-center shadow-2xl bg-white mt-2'>
                            <div><img className='h-38 w-80 p-2' src={news.imageUrl} alt={news.title} /></div>
                            <div className='p-3'>
                                ...
                                <div className='flex p-2'>
                                    ...
                                    <div className="relative ml-auto">
                                        ...
                                        <button onClick={() => toggleMenu(`dropdownMenu${news.id}`)} className='mr-6 ms-120 cursor-pointer'><img className='h-4 w-4' src="https://res.cloudinary.com/dcisrjaxp/image/upload/v1748421203/menu-dots-vertical_1_x3ejev.png" /></button>
